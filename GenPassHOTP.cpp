...
GenPassHOTP::GenPassHOTP(QWidget *parent) : QWidget(parent)
{
    ...
    enterData->setPlaceholderText("Укажите счетчик");
   ...
   // dataStrRadio = new QRadioButton("text", this);
    ...
    connect(openFileDataButton, &QPushButton::clicked, this, &GenPassHOTP::chooseDataFile);
    connect(fileDataRadio, &QRadioButton::toggled, this, &GenPassHOTP::toggleDataInput);
    connect(manualDataRadio, &QRadioButton::toggled, this, &GenPassHOTP::toggleDataInput);

    connect(openFileKeyButton, &QPushButton::clicked, this, &GenPassHOTP::chooseKeyFile);
    connect(fileKeyRadio, &QRadioButton::toggled, this, &GenPassHOTP::toggleKeyInput);
    connect(manualKeyRadio, &QRadioButton::toggled, this, &GenPassHOTP::toggleKeyInput);
    connect(resetButton, &QPushButton::clicked, this, &GenPassHOTP::resetForm);
    connect(encryptButton, &QPushButton::clicked, this, &GenPassHOTP::produceMAC);

}

void GenPassHOTP::chooseDataFile()
{
...
void GenPassHOTP::chooseKeyFile()
{
...
void GenPassHOTP::toggleDataInput()
{
...
void GenPassHOTP::toggleKeyInput()
{
...
void GenPassHOTP::produceMAC()
{
    ...
    if(fileKeyRadio->isChecked())
    {
      ...
      botpHOTPRand(result,n,key,keySizeBytes,block);
    QString output = "";
    for(int i = 0; i< n; i++)
    {

...
DataCryptCFB::DataCryptCFB(QWidget *parent) : QWidget(parent)
{
    ...
    connect(openFileDataButton, &QPushButton::clicked, this, &DataCryptCFB::chooseDataFile);
    connect(fileDataRadio, &QRadioButton::toggled, this, &DataCryptCFB::toggleDataInput);
    connect(manualDataRadio, &QRadioButton::toggled, this, &DataCryptCFB::toggleDataInput);

    connect(openFileKeyButton, &QPushButton::clicked, this, &DataCryptCFB::chooseKeyFile);
    connect(fileKeyRadio, &QRadioButton::toggled, this, &DataCryptCFB::toggleKeyInput);
    connect(manualKeyRadio, &QRadioButton::toggled, this, &DataCryptCFB::toggleKeyInput);

    connect(resetButton, &QPushButton::clicked, this, &DataCryptCFB::resetForm);
    connect(encryptButton, &QPushButton::clicked, this, &DataCryptCFB::encryptData);
    connect(decryptButton, &QPushButton::clicked, this, &DataCryptCFB::decryptData);

    connect(openFilePackageButton, &QPushButton::clicked, this, &DataCryptCFB::choosePackageFile);
    connect(filePackageRadio, &QRadioButton::toggled, this, &DataCryptCFB::togglePackageInput);
    connect(manualPackageRadio, &QRadioButton::toggled, this, &DataCryptCFB::togglePackageInput);
}

void DataCryptCFB::chooseDataFile()
{
...
void DataCryptCFB::chooseKeyFile()
{
...
void DataCryptCFB::choosePackageFile()
{
...
void DataCryptCFB::toggleDataInput()
{
...
void DataCryptCFB::toggleKeyInput()
{
...
void DataCryptCFB::togglePackageInput()
{
...
//            }
    ...
    beltCFBEncr(result,block,dataSizeBytes,key,32,package);

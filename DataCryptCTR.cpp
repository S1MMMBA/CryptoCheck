...
DataCryptCTR::DataCryptCTR(QWidget *parent) : QWidget(parent)
{
    ...
    connect(openFileDataButton, &QPushButton::clicked, this, &DataCryptCTR::chooseDataFile);
    connect(fileDataRadio, &QRadioButton::toggled, this, &DataCryptCTR::toggleDataInput);
    connect(manualDataRadio, &QRadioButton::toggled, this, &DataCryptCTR::toggleDataInput);

    connect(openFileKeyButton, &QPushButton::clicked, this, &DataCryptCTR::chooseKeyFile);
    connect(fileKeyRadio, &QRadioButton::toggled, this, &DataCryptCTR::toggleKeyInput);
    connect(manualKeyRadio, &QRadioButton::toggled, this, &DataCryptCTR::toggleKeyInput);

    connect(resetButton, &QPushButton::clicked, this, &DataCryptCTR::resetForm);
    connect(encryptButton, &QPushButton::clicked, this, &DataCryptCTR::encryptData);
    connect(decryptButton, &QPushButton::clicked, this, &DataCryptCTR::decryptData);

    connect(openFilePackageButton, &QPushButton::clicked, this, &DataCryptCTR::choosePackageFile);
    connect(filePackageRadio, &QRadioButton::toggled, this, &DataCryptCTR::togglePackageInput);
    connect(manualPackageRadio, &QRadioButton::toggled, this, &DataCryptCTR::togglePackageInput);
}

void DataCryptCTR::chooseDataFile()
{
...
void DataCryptCTR::chooseKeyFile()
{
...
void DataCryptCTR::choosePackageFile()
{
...
void DataCryptCTR::toggleDataInput()
{
...
void DataCryptCTR::toggleKeyInput()
{
...
void DataCryptCTR::togglePackageInput()
{
...
void DataCryptCTR::encryptData()
{
    ...
    beltCTR(result,block,dataSizeBytes,key,32,package);

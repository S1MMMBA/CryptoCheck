...
SaveFormatCrypt::SaveFormatCrypt(QWidget *parent) : QWidget(parent)
{
...
//    dataStrRadio->setGeometry(310,10,100,30);
    ...
    connect(openFileDataButton, &QPushButton::clicked, this, &SaveFormatCrypt::chooseDataFile);
    connect(fileDataRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::toggleDataInput);
    connect(manualDataRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::toggleDataInput);

    connect(openFileKeyButton, &QPushButton::clicked, this, &SaveFormatCrypt::chooseKeyFile);
    connect(fileKeyRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::toggleKeyInput);
    connect(manualKeyRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::toggleKeyInput);

    connect(resetButton, &QPushButton::clicked, this, &SaveFormatCrypt::resetForm);
    connect(encryptButton, &QPushButton::clicked, this, &SaveFormatCrypt::encryptData);
    connect(decryptButton, &QPushButton::clicked, this, &SaveFormatCrypt::decryptData);

    connect(openFilePackageButton, &QPushButton::clicked, this, &SaveFormatCrypt::choosePackageFile);
    connect(filePackageRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::togglePackageInput);
    connect(manualPackageRadio, &QRadioButton::toggled, this, &SaveFormatCrypt::togglePackageInput);
}

void SaveFormatCrypt::chooseDataFile()
{
...
void SaveFormatCrypt::chooseKeyFile()
{
...
void SaveFormatCrypt::choosePackageFile()
{
...
void SaveFormatCrypt::toggleDataInput()
{
...
void SaveFormatCrypt::toggleKeyInput()
{
...
void SaveFormatCrypt::togglePackageInput()
{
...
void SaveFormatCrypt::resetForm()
{
...
void SaveFormatCrypt::encryptData()
{
    QString data;
    QString keyStr;
    QString packStr;
    ...
    if(manualDataRadio->isChecked())
    {
        ...
        QString digitsOnly = data;
        digitsOnly.remove(QRegularExpression("[^\\d]"));
        dataSizeBytes = digitsOnly.size();
        result = new unsigned short[dataSizeBytes]();
        block = parseStringToUShortArray(data,dataSizeBytes);
    }
    ...
    if(fileDataRadio->isChecked())
    {
        ...
        result = new unsigned short[dataSizeBytes]();
        block = reinterpret_cast<const unsigned short*>(byteDataArray.constData());
    }
    ...
    beltFMTEncr(result,alphabetSize,block,dataSizeBytes,key,32,package);
    QString output = printByteArray(result,dataSizeBytes,10,data);
    ...
    delete [] result;
    delete [] block;
    //OutPutLabel->setText("отработало");
}

void SaveFormatCrypt::decryptData()
{
    QString data;
    QString keyStr;
    QString packStr;
    ...
    beltFMTDecr(result,alphabetSize,block,dataSizeBytes,key,32,package);
    QString output = printByteArray(result,dataSizeBytes,10,data);
    OutPutLabel->setText(output);

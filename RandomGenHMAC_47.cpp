...
RandomGenHMAC_47::RandomGenHMAC_47(QWidget *parent) : QWidget(parent)
{
   ...
   // dataStrRadio = new QRadioButton("text", this);
    ...
    connect(openFileDataButton, &QPushButton::clicked, this, &RandomGenHMAC_47::chooseDataFile);
    connect(fileDataRadio, &QRadioButton::toggled, this, &RandomGenHMAC_47::toggleDataInput);
    connect(manualDataRadio, &QRadioButton::toggled, this, &RandomGenHMAC_47::toggleDataInput);

    connect(openFileKeyButton, &QPushButton::clicked, this, &RandomGenHMAC_47::chooseKeyFile);
    connect(fileKeyRadio, &QRadioButton::toggled, this, &RandomGenHMAC_47::toggleKeyInput);
    connect(manualKeyRadio, &QRadioButton::toggled, this, &RandomGenHMAC_47::toggleKeyInput);
    connect(resetButton, &QPushButton::clicked, this, &RandomGenHMAC_47::resetForm);
    connect(encryptButton, &QPushButton::clicked, this, &RandomGenHMAC_47::produceMAC);

}

void RandomGenHMAC_47::chooseDataFile()
{
...
void RandomGenHMAC_47::chooseKeyFile()
{
...
void RandomGenHMAC_47::toggleDataInput()
{
...
void RandomGenHMAC_47::toggleKeyInput()
{
...
void RandomGenHMAC_47::resetForm()
{
...
void RandomGenHMAC_47::produceMAC()
{
    ...
    uint8_t* result = new uint8_t[32*n]();
    //uint8_t* result;
...
//             }
   ...
   // beltHMAC(result,block,dataSizeBytes,key,keySizeBytes);
    brngHMACRand(result,32*n,key,keySizeBytes,block,dataSizeBytes);
    QString output = printByteArray(result,32*n);
    ...
    if(fileDataRadio->isChecked())
    {
        ...
        {
            outputFile.write(reinterpret_cast<const char*>(result), 32*n);
            outputFile.close();
